...
export const site = {
	...
	// Church Center giving. /giving/ embeds this inline and also links to it as a
	// fallback, so keep it a plain URL with no modal parameter.
	"givingUrl": "https://thetabletx.churchcenter.com/giving",
