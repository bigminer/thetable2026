...
Error: expect(Buffer).toMatchSnapshot(expected) failed
  ...
  Expected an image 1440px by 2754px, received 1440px by 2055px. 2636048 pixels (ratio 0.67 of all image pixels) are different.

  Snapshot: our-vision-desktop.png
