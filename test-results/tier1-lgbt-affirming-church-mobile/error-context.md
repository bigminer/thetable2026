...
Error: expect(Buffer).toMatchSnapshot(expected) failed
  ...
  Expected an image 390px by 9218px, received 390px by 8859px. 2702861 pixels (ratio 0.76 of all image pixels) are different.

  Snapshot: lgbt-affirming-church-mobile.png
