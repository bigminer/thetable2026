...
Error: expect(Buffer).toMatchSnapshot(expected) failed
  ...
  Expected an image 1440px by 1885px, received 1440px by 1820px. 2038053 pixels (ratio 0.76 of all image pixels) are different.

  Snapshot: our-story-desktop.png
